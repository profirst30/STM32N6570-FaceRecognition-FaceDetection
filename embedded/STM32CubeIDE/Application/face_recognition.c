 ...
 * --onnx-input = "./Exercises/converted_models/mobilefacenet_int8_faces_OE_3_2_0.onnx"
 * --out-dir-prefix = "./Exercises/st_ai_ws/neural_art__face_recognition/"
 ...
 * --load-mpool-file = "./Exercises/memory_pools/model2"
 * --cache-maintenance = true
 * --enable-virtual-mem-pools = true
 * --json-quant-file = "./Exercises/converted_models/mobilefacenet_int8_faces_OE_3_2_0_Q.json"
 * --optimization = 0
 * --Os = true
 * --Omax-ca-pipe = 4
 * --Ocache-opt = true
